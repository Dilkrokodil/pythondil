...
# Подзапросы (влож запросыы)
# 1. однострочные - вернулост одно значение(>,<, =, <> !=, >=, <=)
#
# SELECt amt
# FROM Orders
# WHERE snum =
...
#     if con:
#         con.rollback()
#     print("Oshibka vipolneniya zaprosa")
#
# finally:
#     if con:
#         con.close()
...
#         name NEXT, tr_in INTEGER, buy INTEGER
#     );
#     """)
#
#     # cur.execute("INSERT INTO cars VALUES(NULL, 'Zaporogez', 1000)")
